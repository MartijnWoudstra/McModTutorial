...
public class ShapedRecipeCustom implements IRecipe
{
    ...
    public ShapedRecipeCustom(int par1, int par2, ItemStack[] par3ArrayOfItemStack, ItemStack par4ItemStack)
    {
    ...
    public ShapedRecipeCustom setHasDamage()
    {
        this.hasDamage = true;
        return this;
    }
